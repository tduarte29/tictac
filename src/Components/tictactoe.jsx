...
//Verificador de vitoria passando pelas casas.
    ...
    const won = (winner) => {
        ...
        if (winner==="x") 
        {
           titleRef.current.innerHTML = `Parabéns pela sua vitória: <span>X<span>` 
        }
        else
        {
            titleRef.current.innerHTML = `Parabéns pela sua vitória:<span>O<span>`
        }
    }
    ...
    const draw = () => {
        setLock(true);
        titleRef.current.innerHTML = "Deu Velha!! O jogo empatou.";
      }
